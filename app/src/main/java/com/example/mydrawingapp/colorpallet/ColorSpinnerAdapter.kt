package com.example.mydrawingapp.colorpallet
...
import com.example.mydrawingapp.MainActivity
import com.example.mydrawingapp.R

class ColorSpinnerAdapter(context: Context, list: List<ColorObject>) : ArrayAdapter<ColorObject>
    (context, 0, list) {
